...
pub fn Sidebar() -> impl IntoView {
    ...
    let (medium, medium_set) = create_signal(String::new());
    ...
    create_effect(move |_| {
        ...
        let subtitle =
            "<h2 class=\"pt-2 text-lighttext-950 dark:text-darktext-50\">Etienne Collin</h2>";
        ...
        medium_set.set(format!(
            "<div>{}{}{}</div>{}",
            title, subtitle, description, image
        ));
        large_set.set(format!("{}{}{}{}", title, image, subtitle, description));
    });
