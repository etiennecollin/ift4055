...
pub fn Section(
    ...
    let class_string = format!("bg-lightbg-200 dark:bg-darkbg-800 rounded-xl py-2 px-5 lg:py-3 lg:px-5 {} print:break-before-all print:break-after-all print:break-inside-avoid", extra_classes.unwrap_or_default());
    view! {
